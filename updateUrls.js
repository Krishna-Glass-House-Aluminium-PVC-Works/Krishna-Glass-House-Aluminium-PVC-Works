...
for (const filePath of allFiles) {
  ...
  if (filePath.endsWith('.html')) {
    ...
    // Check if relativeRoute is index.html of an inner folder, e.g., partner/index.html
    if (relativeRoute.endsWith('/index.html')) {
      relativeRoute = relativeRoute.replace('/index.html', '/');
    }
